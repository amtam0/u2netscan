#!/bin/bash
# 
# Developed by Fred Weinhaus 6/9/2009 .......... revised 11/5/2020
# 
# ------------------------------------------------------------------------------
# 
# Licensing:
...
# [-a adaptblur] [-T] [-p padamt] [-b bgcolor] [-F fuzzval] [-i invert] 
# [-C compression] infile outfile
...
imdir="/usr/bin" #(such as imdir="/usr/local/bin" or imdir="/usr/bin")
PROGNAME="${imdir}:${PATH}"
